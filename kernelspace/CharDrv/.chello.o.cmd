cmd_/opt/examples/kernelspace/CharDrv/chello.o := arm-none-linux-gnueabi-gcc -Wp,-MD,/opt/examples/kernelspace/CharDrv/.chello.o.d  -nostdinc -isystem /opt/armsystem/arm-2009q1/bin/../lib/gcc/arm-none-linux-gnueabi/4.3.3/include -Iinclude  -I/opt/armsystem/linux-2.6.32/arch/arm/include -include include/linux/autoconf.h -D__KERNEL__ -mlittle-endian -Iarch/arm/mach-versatile/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Os -marm -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=5 -march=armv5te -mtune=arm9tdmi -msoft-float -Uarm -fno-stack-protector -fomit-frame-pointer -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow  -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(chello)"  -D"KBUILD_MODNAME=KBUILD_STR(chello)"  -c -o /opt/examples/kernelspace/CharDrv/chello.o /opt/examples/kernelspace/CharDrv/chello.c

deps_/opt/examples/kernelspace/CharDrv/chello.o := \
  /opt/examples/kernelspace/CharDrv/chello.c \
  ...
  /opt/armsystem/linux-2.6.32/arch/arm/include/asm/hardirq.h \
  /opt/armsystem/linux-2.6.32/arch/arm/include/asm/irq.h \
...
/opt/examples/kernelspace/CharDrv/chello.o: $(deps_/opt/examples/kernelspace/CharDrv/chello.o)
