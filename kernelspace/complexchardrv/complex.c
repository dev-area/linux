...
static int device_ioctl(struct inode *inode,struct file*file,unsigned int num,unsigned long param)
{
	unsigned int r;
...
static int device_mmap(struct file *file,struct vm_area_struct* vma)
{
	...
	if(remap_pfn_range(vma,vma->vm_start,PHY_IO_ADD>>PAGE_SHIFT,
